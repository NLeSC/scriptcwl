# -*- coding: utf-8 -*-
#
# scriptcwl documentation build configuration file, created by
...
htmlhelp_basename = 'scriptcwldoc'
...
latex_documents = [
    (master_doc, 'scriptcwl.tex', u'scriptcwl Documentation',
...
man_pages = [
    (master_doc, 'scriptcwl', u'scriptcwl Documentation',
     [author], 1)
]
